...
const flutterwave_controller_1 = require("./flutterwave.controller");
...
exports.FlutterwaveModule = FlutterwaveModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [flutterwave_controller_1.FlutterwaveController],
        providers: [flutterwave_service_1.FlutterwaveService, prisma_service_1.PrismaService],
