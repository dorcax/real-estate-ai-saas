...
const companyMembershipGuard_1 = require("../guard/companyMembershipGuard");
const Auth = (roles, requireCompany) => {
    ...
    if (requireCompany && roles.length === 0) {
        return (0, common_1.applyDecorators)((0, common_1.UseGuards)(authGuard_guard_1.AuthGuard, companyMembershipGuard_1.CompanyMembershipGuard));
    }
    if (!requireCompany && roles.length > 0) {
